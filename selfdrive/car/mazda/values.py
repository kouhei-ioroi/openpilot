...
FW_VERSIONS = {
  ...
  CAR.MAZDA6: {
    ...
    (Ecu.engine, 0x7e0, None): [
      b'SH5H-188K2-H\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',  
    ],
    (Ecu.fwdRadar, 0x764, None): [
	  b'G46L-67XA1-C\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
    (Ecu.esp, 0x760, None): [
      b'GMD7-437AS-0-70\x00\x00\x00\x00\x00\x00\x00\x00\x00',    
    ],
    (Ecu.fwdCamera, 0x706, None): [
      b'GMG6-67XK2-G\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
    (Ecu.transmission, 0x7e1, None): [
      b'SHBW-21PS1-C\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
  },
